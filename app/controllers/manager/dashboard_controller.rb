...
module Manager
  class DashboardController < BaseController
    ...
    def prepare_index
      data_charts = Manager::Dashboard::PrepareDataForChartsService.call(current_user)
      data_tables = Manager::Dashboard::PrepareDataForTablesService.call(current_user)
